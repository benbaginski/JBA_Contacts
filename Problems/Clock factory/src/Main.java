...
class ClockFactory {
    ...
    public Clock produce(String type) {
        ...
        else if (type.equals("DIGITAL")) return new DigitalClock();
        else if (type.equals("MECH")) return new MechanicalClock();
        else if (produceToyClock == true) return new ToyClock();
        else return null;
    }
}
